...
test.serial('Setup', t => {
    ...
    t.true(_rec2._expr(_rec2._capt(_rec2._capt(_rec2._capt(AgentStub, 'arguments/0/object/object').hasMany, 'arguments/0/object').called, 'arguments/0'), {
        ...
        visitorKeys: _powerAssertVisitorKeys
    }), 'AgentModel.hasMany was executed'); //estas propiedades o estos mensajes me los entrega Sinon.spy
...
test.serial('Agent#createOrUpdate - exist', async t => {
    ...
    t.true(_rec21._expr(_rec21._capt(_rec21._capt(_rec21._capt(AgentStub, 'arguments/0/object/object').findOne, 'arguments/0/object').called, 'arguments/0'), {
        content: 't.true(AgentStub.findOne.called, \'findOne shoul be called on model\')',
        filepath: 'tests/agent-tests.js',
        line: 152,
        async: true,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"findOne","range":[17,24]},"computed":false,"range":[7,24]},"property":{"type":"Identifier","name":"called","range":[25,31]},"computed":false,"range":[7,31]},{"type":"StringLiteral","value":"findOne shoul be called on model","range":[33,67]}],"range":[0,68]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"findOne","range":[17,24]},{"type":{"label":"."},"range":[24,25]},{"type":{"label":"name"},"value":"called","range":[25,31]},{"type":{"label":","},"range":[31,32]},{"type":{"label":"string"},"value":"findOne shoul be called on model","range":[33,67]},{"type":{"label":")"},"range":[67,68]}]',
        visitorKeys: _powerAssertVisitorKeys
    }), 'findOne shoul be called on model');
...
test.serial('Agent#createOrUpdate - new', async t => {
    ...
    t.true(_rec26._expr(_rec26._capt(_rec26._capt(_rec26._capt(AgentStub, 'arguments/0/callee/object/object').update, 'arguments/0/callee/object').calledWith(_rec26._capt({
        ...
        content: 't.true(AgentStub.update.calledWith({ where: { uuid: newAgent.uuid } }), \'findOne should be called with uuid args\')',
        filepath: 'tests/agent-tests.js',
        line: 164,
        async: true,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"update","range":[17,23]},"computed":false,"range":[7,23]},"property":{"type":"Identifier","name":"calledWith","range":[24,34]},"computed":false,"range":[7,34]},"arguments":[{"type":"ObjectExpression","properties":[{"type":"ObjectProperty","key":{"type":"Identifier","name":"where","range":[37,42]},"value":{"type":"ObjectExpression","properties":[{"type":"ObjectProperty","key":{"type":"Identifier","name":"uuid","range":[46,50]},"value":{"type":"MemberExpression","object":{"type":"Identifier","name":"newAgent","range":[52,60]},"property":{"type":"Identifier","name":"uuid","range":[61,65]},"computed":false,"range":[52,65]},"computed":false,"shorthand":false,"range":[46,65]}],"range":[44,67]},"computed":false,"shorthand":false,"range":[37,67]}],"range":[35,69]}],"range":[7,70]},{"type":"StringLiteral","value":"findOne should be called with uuid args","range":[72,113]}],"range":[0,114]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"update","range":[17,23]},{"type":{"label":"."},"range":[23,24]},{"type":{"label":"name"},"value":"calledWith","range":[24,34]},{"type":{"label":"("},"range":[34,35]},{"type":{"label":"{"},"range":[35,36]},{"type":{"label":"name"},"value":"where","range":[37,42]},{"type":{"label":":"},"range":[42,43]},{"type":{"label":"{"},"range":[44,45]},{"type":{"label":"name"},"value":"uuid","range":[46,50]},{"type":{"label":":"},"range":[50,51]},{"type":{"label":"name"},"value":"newAgent","range":[52,60]},{"type":{"label":"."},"range":[60,61]},{"type":{"label":"name"},"value":"uuid","range":[61,65]},{"type":{"label":"}"},"range":[66,67]},{"type":{"label":"}"},"range":[68,69]},{"type":{"label":")"},"range":[69,70]},{"type":{"label":","},"range":[70,71]},{"type":{"label":"string"},"value":"findOne should be called with uuid args","range":[72,113]},{"type":{"label":")"},"range":[113,114]}]',
        visitorKeys: _powerAssertVisitorKeys
    }), 'findOne should be called with uuid args');
    ...
    t.true(_rec29._expr(_rec29._capt(_rec29._capt(_rec29._capt(AgentStub, 'arguments/0/callee/object/object').update, 'arguments/0/callee/object').calledWith(_rec29._capt(newAgent, 'arguments/0/arguments/0')), 'arguments/0'), {
        content: 't.true(AgentStub.update.calledWith(newAgent), \'create should be called with uuid args\')',
        filepath: 'tests/agent-tests.js',
        line: 169,
        async: true,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"update","range":[17,23]},"computed":false,"range":[7,23]},"property":{"type":"Identifier","name":"calledWith","range":[24,34]},"computed":false,"range":[7,34]},"arguments":[{"type":"Identifier","name":"newAgent","range":[35,43]}],"range":[7,44]},{"type":"StringLiteral","value":"create should be called with uuid args","range":[46,86]}],"range":[0,87]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"update","range":[17,23]},{"type":{"label":"."},"range":[23,24]},{"type":{"label":"name"},"value":"calledWith","range":[24,34]},{"type":{"label":"("},"range":[34,35]},{"type":{"label":"name"},"value":"newAgent","range":[35,43]},{"type":{"label":")"},"range":[43,44]},{"type":{"label":","},"range":[44,45]},{"type":{"label":"string"},"value":"create should be called with uuid args","range":[46,86]},{"type":{"label":")"},"range":[86,87]}]',
        visitorKeys: _powerAssertVisitorKeys
    }), 'create should be called with uuid args');

    t.deepEqual(agent, newAgent, 'agent should be the same');
});
//# sourceMappingURL=/home/juanjo/MEGAsync/platziverse/platziverse-db/node_modules/.cache/ava/7659a54e3aae6be857eae0abc3ede1c7.js.map