...
test.serial('Agent#createOrUpdate - new', async t => {
  ...
  t.true(_rec29._expr(_rec29._capt(_rec29._capt(_rec29._capt(AgentStub, 'arguments/0/callee/object/object').create, 'arguments/0/callee/object').calledWith(_rec29._capt(newAgent, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(AgentStub.create.calledWith(newAgent), \'create should be called with uuid args\')',
    filepath: 'tests/agent-tests.js',
    line: 170,
    async: true,
    ...
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"create","range":[17,23]},{"type":{"label":"."},"range":[23,24]},{"type":{"label":"name"},"value":"calledWith","range":[24,34]},{"type":{"label":"("},"range":[34,35]},{"type":{"label":"name"},"value":"newAgent","range":[35,43]},{"type":{"label":")"},"range":[43,44]},{"type":{"label":","},"range":[44,45]},{"type":{"label":"string"},"value":"create should be called with uuid args","range":[46,86]},{"type":{"label":")"},"range":[86,87]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'create should be called with uuid args');

  t.deepEqual(agent, newAgent, 'agent should be the same');
});
//# sourceMappingURL=/home/juanjo/MEGAsync/platziverse/platziverse-db/node_modules/.cache/ava/eca2d7d092329058914c8c002adbca49.js.map